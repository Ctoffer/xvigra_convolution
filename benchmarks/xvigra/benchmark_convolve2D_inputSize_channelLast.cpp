...
template <typename ElementType>
void benchmark_convolve2D_v2_inputSize_channelLast(benchmark::State& state) {
	int inputHeight = static_cast<int>(state.range(0) + 1);
	int inputWidth = static_cast<int>(state.range(0) - 1);
	int inputChannels = 3;
	int kernelHeight = 8;
...
template <typename ElementType>
void benchmark_convolve2D_v3_inputSize_channelLast(benchmark::State& state) {
	int inputHeight = static_cast<int>(state.range(0) + 1);
	int inputWidth = static_cast<int>(state.range(0) - 1);
	int inputChannels = 3;
	int kernelHeight = 8;
...
template <typename ElementType>
void benchmark_convolve2D_v4_inputSize_channelLast(benchmark::State& state) {
	int inputHeight = static_cast<int>(state.range(0) + 1);
	int inputWidth = static_cast<int>(state.range(0) - 1);
	int inputChannels = 3;
	int kernelHeight = 8;
...
template <typename ElementType>
void benchmark_convolve2D_v5_inputSize_channelLast(benchmark::State& state) {
	int inputHeight = static_cast<int>(state.range(0) + 1);
	int inputWidth = static_cast<int>(state.range(0) - 1);
	int inputChannels = 3;
	int kernelHeight = 8;
...
BENCHMARK_SINGLE_VERSION(benchmark_convolve2D_v1_inputSize_channelLast);
BENCHMARK_SINGLE_VERSION(benchmark_convolve2D_v2_inputSize_channelLast);
BENCHMARK_SINGLE_VERSION(benchmark_convolve2D_v3_inputSize_channelLast);
BENCHMARK_SINGLE_VERSION(benchmark_convolve2D_v4_inputSize_channelLast);
BENCHMARK_SINGLE_VERSION(benchmark_convolve2D_v5_inputSize_channelLast);
