...
void benchmark_xstrided_view_copy_paddingStride_Z_assign(benchmark::State& state) {
    ...
    int z = inputZ / 2;
    auto view = xt::strided_view(data, {z, xt::range(paddingStartY, inputY - paddingEndY, strideY), xt::range(paddingStartX, inputX - paddingEndX, strideX)});
...
template <typename ElementType>
void benchmark_xstrided_view_copy_paddingStride_Z_operatorCallAgainstCache(benchmark::State& state) {
    SETUP_VARIABLES
...
template <typename ElementType>
void benchmark_xstrided_view_copy_paddingStride_Z_operatorCallCacheAligned(benchmark::State& state) {
    SETUP_VARIABLES
...
BENCHMARK_SINGLE_VERSION(benchmark_xstrided_view_copy_paddingStride_Z_operatorCallAgainstCache);
BENCHMARK_SINGLE_VERSION(benchmark_xstrided_view_copy_paddingStride_Z_operatorCallCacheAligned);
