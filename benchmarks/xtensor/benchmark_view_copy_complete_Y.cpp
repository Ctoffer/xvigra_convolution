...
void benchmark_view_copy_complete_Y_assign(benchmark::State& state) {
    ...
    int y = inputY / 2;
    auto view = xt::view(data, xt::all(), y, xt::all());
...
template <typename ElementType>
void benchmark_view_copy_complete_Y_operatorCallAgainstCache(benchmark::State& state) {
    SETUP_VARIABLES
...
template <typename ElementType>
void benchmark_view_copy_complete_Y_operatorCallCacheAligned(benchmark::State& state) {
    SETUP_VARIABLES
...
BENCHMARK_SINGLE_VERSION(benchmark_view_copy_complete_Y_operatorCallAgainstCache);
BENCHMARK_SINGLE_VERSION(benchmark_view_copy_complete_Y_operatorCallCacheAligned);
