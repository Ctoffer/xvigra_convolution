...
void benchmark_xstrided_view_copy_complete_Z_assign(benchmark::State& state) {
    ...
    int z = inputZ / 2;
    auto view = xt::strided_view(data, {z, xt::all(), xt::all()});
...
template <typename ElementType>
void benchmark_xstrided_view_copy_complete_Z_operatorCallAgainstCache(benchmark::State& state) {
    SETUP_VARIABLES
...
template <typename ElementType>
void benchmark_xstrided_view_copy_complete_Z_operatorCallCacheAligned(benchmark::State& state) {
    SETUP_VARIABLES
...
BENCHMARK_SINGLE_VERSION(benchmark_xstrided_view_copy_complete_Z_operatorCallAgainstCache);
BENCHMARK_SINGLE_VERSION(benchmark_xstrided_view_copy_complete_Z_operatorCallCacheAligned);
